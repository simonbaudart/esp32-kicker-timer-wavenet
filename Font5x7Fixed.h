...
// Fixed-width 5x7 font (digits, letters, !, :)
const uint8_t Font5x7Fixed[] PROGMEM = {
  0x06,  // fixed width = 6 (5 pixels + 1 space)
  0x07,  // height = 7
  0x21,  // first char (!)
  0x7A,  // last char (z)
  ...
  0x00,0x41,0x7F,0x40,0x00,0x00, // 1
